...
export default function GalleryModal({ open, form, setForm, onSave, onClose, saving }) {
  ...
  const handleSave = () => {
    ...
    if (form.image instanceof File && form.image.size > MAX_FILE_SIZE) {
      toast.error("File size too large. Maximum allowed is 5MB");
      return;
    }

    let imageToSend = "";
    if (form.image instanceof File) imageToSend = form.image;
    else if (typeof form.image === "string" && form.image.trim() !== "") imageToSend = form.image;

    const payload = { ...form, image: imageToSend };
    onSave(payload);
  };
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div className="col-span-1 flex flex-col items-center">
                  ...
                  <p className="text-xs text-gray-500 mt-2 italic">
                    Recommended: Upload a 1:1 square image (e.g., 1080×1080 px)
                  </p>
