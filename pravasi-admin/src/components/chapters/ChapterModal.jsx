        ...
        >
          ...
          <form onSubmit={handleSubmit} className="p-5 space-y-4">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              ...
              <div className="md:col-span-2 space-y-2">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
                  <input
                    value={form.contact.address}
                    onChange={(e) =>
                      setForm((s) => ({ ...s, contact: { ...s.contact, address: e.target.value } }))
                    }
                    placeholder="Address"
                    className="p-3 rounded-lg bg-white/70"
                  />
                  <input
                    value={form.contact.phone}
                    onChange={(e) =>
                      setForm((s) => ({ ...s, contact: { ...s.contact, phone: e.target.value } }))
                    }
                    placeholder="Phone"
                    className="p-3 rounded-lg bg-white/70"
                  />
                  <input
                    value={form.contact.email}
                    onChange={(e) =>
                      setForm((s) => ({ ...s, contact: { ...s.contact, email: e.target.value } }))
                    }
                    placeholder="Email"
                    className="p-3 rounded-lg bg-white/70"
                  />
                  <input
                    value={form.contact.website}
                    onChange={(e) =>
                      setForm((s) => ({ ...s, contact: { ...s.contact, website: e.target.value } }))
                    }
                    placeholder="Website"
                    className="p-3 rounded-lg bg-white/70"
                  />
              ...
              {/* IMAGE SECTION */}
              <div className="space-y-3">
                <div className="w-full h-40 rounded-lg overflow-hidden bg-gray-100 flex items-center justify-center border">
                  {preview ? (
                ...
                <label className="block">
                  <input type="file" accept="image/*" onChange={handleImage} className="hidden" />
                  <div className="px-4 py-2 bg-white/70 rounded-lg text-center border cursor-pointer">
                    Choose Image
                  </div>
                </label>
