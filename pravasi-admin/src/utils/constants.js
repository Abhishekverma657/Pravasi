...
export const BASE_URL =
  import.meta.env.VITE_API_BASE_URL || "https://api.rajasthanpravasi.in/api";
export const IMAGE_BASE_URL = import.meta.env.VITE_IMAGE_BASE_URL || "https://rajasthanpravasi.in";
